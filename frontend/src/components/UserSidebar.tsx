...
const UserSidebar: React.FC = () => {
  ...
  return (
    <div
      className={`bg-gray-700 text-white transition-all duration-300 flex flex-col ${
        isOpen ? "w-64" : "w-20"
      }`}
    >
      {/* Sidebar Toggle Button */}
      <button onClick={toggleSidebar} className="p-4 bg-gray-600">
      ...
      <div className={`flex flex-col ${isOpen ? "block" : "hidden"} md:block p-6`}>
        ...
        <NavLink to="/dashboard/bmi" className={linkClasses}>
          Calculate BMI
        </NavLink>
        <NavLink to="/dashboard/meal" className={linkClasses}>
          Plan Generator
        </NavLink>
